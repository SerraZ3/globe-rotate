d3 = (function () {
  ...
  function C(n) {
    return (
      arguments.length || (n = Bo.ascending),
      function (t, e) {
  ...
  function nt(n, t, e) {
    ...
    return (
      ...
      (i = et(i) * Za),
      at(
        ut(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
        ut(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
        ut(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
      )
    );
  }
  function tt(n, t, e) {
    return n > 0
      ? W(Math.atan2(e, t) * qa, Math.sqrt(t * t + e * e), n)
      : W(0 / 0, 0 / 0, n);
  }
  function et(n) {
  ...
  function ht(n, t, e) {
    ...
    var r = rt((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Ya),
      u = rt((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Ia),
      i = rt((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Za);
  ...
  function Mt() {
    var n = _t(),
      t = bt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(Ga), (Ga = setTimeout(Mt, t))), (Ja = 0))
      : ((Ja = 1), Qa(Mt));
  }
  function _t() {
    var n = Date.now();
  ...
  function Kt(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - Ca - Na : Ca - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - Ca - Na : Ca - t[1])
    );
  }
  function Qt(n, t) {
    var e = n[0],
      ...
      if (l)
        for (
          ...
          var m = n[0],
            ...
            w = p * x;
          if (
            (gc.add(Math.atan2(w * Math.sin(_), v * M + w * Math.cos(_))),
            (i += b ? _ + (_ >= 0 ? Aa : -Aa) : _),
            b ^ (h >= e) ^ (m >= e))
          ) {
            var S = Rt(qt(f), qt(n));
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * qa,
              Math.atan2(o, Math.sqrt(r * r + u * u)) * qa,
            ];
          }
        : function () {
            return [n * qa, t * qa];
  ...
  function Fe(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(o / r, 1 / i)) - Ca,
          ];
        }),
        e)
      : Ye;
  ...
  function nr(n) {
    ...
    for (
      var c = i;
      c.circle && ca(e - c.circle.x) < Na && ca(r - c.circle.cy) < Na;
    ...
    for (
      var s = o;
      s.circle && ca(e - s.circle.x) < Na && ca(r - s.circle.cy) < Na;
  ...
  function sr(n) {
    var t = n.circle;
    t &&
      (t.P || (Wc = t.N), Jc.remove(t), Kc.push(t), yr(t), (n.circle = null));
  }
  function lr(n) {
    for (
      var t, e = Xc, r = ue(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
      ...
      (t = e[u]),
        (!fr(t, n) ||
          !r(t) ||
          (ca(t.a.x - t.b.x) < Na && ca(t.a.y - t.b.y) < Na)) &&
  ...
  function br(n, t) {
    ...
    for (Xc = [], $c = new Array(n.length), Bc = new mr(), Jc = new mr(); ; )
      if (((u = Wc), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          (($c[i.i] = new ur(i)), tr(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        nr(u.arc);
  ...
  function zr(n, t) {
    for (
      var e, r = Bo.interpolators.length;
      --r >= 0 && !(e = Bo.interpolators[r](n, t));
  ...
  function Kr(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * qa),
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: Tr(a[0], c[0]) }, { i: 3, x: Tr(a[1], c[1]) }))
        : c[0] || c[1]
        ? r.push("translate(" + c + ")")
        : r.push(""),
      s != l
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: Tr(f, h) })
  ...
  function au(n, t) {
    if (n === t) return n;
    for (
      var e = ou(n), r = ou(t), u = e.pop(), i = r.pop(), o = null;
      u === i;
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== a._pack_prev && !Iu(c, i);
              c = c._pack_prev, d++
            );
          p
            ? (d > v || (v == d && u.r < r.r) ? Yu(r, (u = a)) : Yu((r = c), u),
              o--)
            : (Ou(r, i), (u = i), t(i));
        }
      var m = (l + f) / 2,
  ...
  function hi(n, t, e) {
    ...
    return Bo.format(
      e
        ? e.replace(ic, function (n, t, e, u, i, o, a, c, s, l) {
  ...
  function pi(n, t) {
    var e = gi(t[2]);
    return n in fs
      ? Math.abs(e - gi(Math.max(Math.abs(t[0]), Math.abs(t[1])))) +
          +("e" !== n)
      : e - 2 * ("%" === n);
  }
  function vi(n, t, e, r) {
  ...
  function di(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function (o) {
        return arguments.length
          ? ((u = mi((t = o))), (i = mi(1 / t)), n.domain(e.map(u)), r)
          : t;
      }),
      (r.copy = function () {
  ...
  function Ai(n) {
    function t(t) {
      ...
      for (
        var c, s = [], l = [], f = -1, h = t.length, g = vt(e), p = vt(r);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = Ms.get(n) || Ci).key),
            t)
          : o;
      }),
  ...
  function Ri(n, t) {
    return n.length < 3
      ? Ci(n)
      : n[0] +
          Pi((n.push(n[0]), n), Ui([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function Di(n, t) {
  ...
  function Wi(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = Ms.get(n) || Ci).key),
            (s = a.reverse || a),
            (l = a.closed ? "M" : "L"),
            t)
          : c;
  ...
  (Bo.ascending = function (n, t) {
    ...
    (Bo.median = function (t, e) {
      return (
        ...
        (t = t.filter(n)),
        t.length ? Bo.quantile(t.sort(Bo.ascending), 0.5) : void 0
      );
    }),
  ...
  (Bo.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        xa.hasOwnProperty(e) ? { space: xa[e], local: n } : n
      );
    },
  }),
    ...
    (ya.transition = function () {
      for (
        var n,
          ...
          e = ks || ++Ls,
          r = [],
          u = Es || { time: Date.now(), ease: Fr, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
  ...
  (Bo.interpolateZoom = function (n, t) {
    ...
    (Bo.behavior.zoom = function () {
      ...
      function l() {
        ...
        function i() {
          for (
            var n, t, e, i, o = Bo.touches(p), c = 0, s = o.length;
            s > c;
            ++c, i = null
          )
        ...
        function h() {
          if (Bo.event.touches.length) {
            for (
              var t = Bo.event.changedTouches, e = 0, r = t.length;
              r > e;
              ++e
            )
      ...
      function h() {
        ...
        y ? clearTimeout(y) : (q.call(this), o(n)),
          (y = setTimeout(function () {
            (y = null), c(n);
          }, 50)),
          f();
        var e = m || Bo.mouse(this);
        d || (d = t(e)), r(Math.pow(2, 0.002 * Pa()) * S.k), u(e, d), a(n);
      }
      function p() {
        d = null;
      }
    ...
    (Bo.hcl = function (n, t, e) {
      return 1 === arguments.length
        ? n instanceof J
          ...
          : n instanceof Q
          ? tt(n.l, n.a, n.b)
          : tt((n = ht((n = Bo.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
        : W(+n, +t, +e);
    });
  ...
  (Bo.timer = function (n, t, e) {
    ...
    Wa ? (Wa.n = i) : (Ba = i),
      (Wa = i),
      Ja || ((Ga = clearTimeout(Ga)), (Ja = 1), Qa(Mt));
  }),
  ...
  var ic =
    ...
    oc = Bo.map({
      ...
      r: function (n, t) {
        return (n = Bo.round(n, St(n, t))).toFixed(
  ...
  (Bo.geo.bounds = (function () {
    ...
    (Bo.geo.centroid = function (n) {
      ...
      return La > u &&
        ...
        (e = _c),
        (r = bc),
        Na > dc && ((t = mc), (e = yc), (r = xc)),
        (u = t * t + e * e + r * r),
        La > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * qa, F(r / Math.sqrt(u)) * qa];
    });
  var vc,
    dc,
    mc,
        ...
        (n.translate = function (t) {
          ...
          return (
            ...
            (r = o
              ...
              .clipExtent([
                [l - 0.425 * s + Na, f + 0.12 * s + Na],
                [l - 0.214 * s - Na, f + 0.234 * s - Na],
              ])
              .stream(c).point),
            (u = a
              .translate([l - 0.205 * s, f + 0.212 * s])
              .clipExtent([
                [l - 0.214 * s + Na, f + 0.166 * s + Na],
                [l - 0.115 * s - Na, f + 0.234 * s - Na],
              ])
              .stream(c).point),
            n
          );
  ...
  (Bo.geo.path = function () {
    ...
    return (
      ...
      (n.projection = function (n) {
        return arguments.length
          ? ((u = (e = n) ? n.stream || xe(n) : dt), t())
          : e;
      }),
      (n.context = function (n) {
        return arguments.length
          ? ((i = null == (r = n) ? new fe() : new me(n)),
    ...
    (Bo.geo.rotation = function (n) {
      ...
      return (
        (n = Ae((n[0] % 360) * Ta, n[1] * Ta, n.length > 2 ? n[2] * Ta : 0)),
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Ta, t[1] * Ta)), (t[0] *= qa), (t[1] *= qa), t
          );
        }),
        t
      );
    ...
    (Vc.clip = function (n) {
      for (
        ...
        for (
          ...
          (o = t[e]),
            Be(o, l, u)
              ? (Be(i, l, u) || n.push(We(i, o, l, u)), n.push(o))
              : Be(i, l, u) && n.push(We(i, o, l, u)),
            (i = o);
        a && n.push(n[0]), (l = u);
      }
      return n;
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ((t = u.R),
                t.C && ((t.C = !1), (u.C = !0), xr(this, u), (t = u.R)),
                (t.L && t.L.C) || (t.R && t.R.C))
              ) {
                (t.R && t.R.C) ||
                  ((t.L.C = !1), (t.C = !0), Mr(this, t), (t = u.R)),
                  (t.C = u.C),
                  (u.C = t.R.C = !1),
                  xr(this, u),
                  (n = this._);
              ...
              ((t = u.L),
              t.C && ((t.C = !1), (u.C = !0), Mr(this, u), (t = u.L)),
              (t.L && t.L.C) || (t.R && t.R.C))
            ) {
              (t.L && t.L.C) ||
                ((t.R.C = !1), (t.C = !0), xr(this, t), (t = u.L)),
                (t.C = u.C),
                (u.C = t.L.C = !1),
                Mr(this, u),
                (n = this._);
    ...
    (Bo.geom.voronoi = function (n) {
      function t(n) {
        var t = new Array(n.length),
          ...
          o = a[1][1];
        return (
          br(e(n), a).cells.forEach(function (e, a) {
            var c = e.edges,
              s = e.site,
              l = (t[a] = c.length
                ? c.map(function (n) {
      ...
      return n
        ...
        : ((t.links = function (n) {
          ...
          (t.triangles = function (n) {
            var t = [];
            return (
              br(e(n)).cells.forEach(function (e, r) {
                for (
                  var u,
                    i,
                    o = e.site,
  ...
  (Bo.geom.delaunay = function (n) {
    ...
    (Bo.geom.quadtree = function (n, t, e, r, u) {
          ...
          if (!isNaN(e) && !isNaN(r))
            if (n.leaf) {
              var c = n.x,
                l = n.y;
              if (null != c)
                if (ca(c - e) + ca(l - r) < 0.01) s(n, t, e, r, u, i, o, a);
                else {
                  var f = n.point;
      ...
      return (o = arguments.length)
        ? ((a = kr), (c = Er), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
        : ((i.x = function (n) {
          ...
          return (
            e ||
              (e = Bo.behavior
                .drag()
                .origin(dt)
                .on("dragstart.force", cu)
                .on("drag.force", t)
                .on("dragend.force", su)),
            arguments.length
              ? (this.on("mouseover.force", lu)
                  .on("mouseout.force", fu)
                  .call(e),
                void 0)
              : e
          );
  ...
  Bo.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : cs.get(t) || _u), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : ss.get(t) || bu), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
          ...
          if (t) {
            for (
              ...
              (c = Lu(c)),
                ...
                u > 0 && (ju(Hu(a, n, r), n, u), (s += u), (l += u)),
                (f += a._tree.mod),
                (s += i._tree.mod),
                (h += c._tree.mod),
                (l += o._tree.mod);
            a && !Tu(o) && ((o._tree.thread = a), (o._tree.mod += f - l)),
              i &&
                !Lu(c) &&
      ...
      return (
        ...
        (i.padding = function (n) {
          function t(t) {
            ...
            return null == e
              ? Qu(t)
              : ni(t, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return ni(t, n);
          }
    ...
    function n(i) {
      i.each(function () {
        ...
        var l,
          f = Bo.transition(i),
          h = Bo.transition(o);
        c && ((l = ei(c)), h.attr("x", l[0]).attr("width", l[1] - l[0]), e(f)),
          s &&
            ((l = ei(s)), h.attr("y", l[0]).attr("height", l[1] - l[0]), r(f)),
          t(f);
      });
    }
    function t(n) {
  ...
  (Ds.year = so(
    ...
    Us.forEach(function (n, t) {
      ...
      var e = (Ds[n] = so(
        function (n) {
          return (
            (n = Ds.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
